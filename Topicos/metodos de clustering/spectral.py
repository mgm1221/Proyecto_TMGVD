...
model = MultiviewSpectralClustering(num_clusters, 42)
...
with open(f'/Users/martingarces/Desktop/UdeC/2024-2/Topicos en manejos de grandes volumenes de datos/Proyecto_Semestral/labels/spectral_multi_view_batch_{start_batch}.json','w') as file:
